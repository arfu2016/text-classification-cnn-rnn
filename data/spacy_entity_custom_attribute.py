...
@Module    : spacy_entity_custom_attribute.py
@Author    : Deco [deco@cubee.com]
@Created   : 5/29/18 5:19 PM
@Desc      : 
"""
...
def main(text="Alphabet Inc. is the company behind Google.", *companies):
    ...
    print('Tokens',
          [t.text for t in doc])  # company names from the list are merged
    print('Doc has_tech_org', doc._.has_tech_org)  # Doc contains tech orgs
    print('Token 0 is_tech_org',
          doc[0]._.is_tech_org)  # "Alphabet Inc." is a tech org
    print('Token 1 is_tech_org', doc[1]._.is_tech_org)  # "is" is not
    print('Entities',
          [(e.text, e.label_) for e in doc.ents])  # all orgs are entities
